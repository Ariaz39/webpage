...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="#" class="brand-link">
      ...
      <span class="brand-text font-weight-light">IamSoftware</span>
    </a>
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="#" class="d-block">Alejandro Ariaz</a>
        </div>
      </div>
  ...
  <footer class="main-footer text-sm">
    ...
    <!-- Default to the left -->
    <strong>Copyright &copy; {{date('Y')}} <a href="https://iamsoftware.co" target="_blank">IamSoftware</a>.</strong> All rights reserved.
  </footer>
</div>
<!-- ./wrapper -->
